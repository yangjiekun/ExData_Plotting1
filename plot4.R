...
png("plot4.png")
par(mfcol = c(2, 2))
plot(power2Day$Time, power2Day$Global_active_power, ylab = "Global Active Power", xlab = "", type = "l")
...
with(power2Day, plot(Time, Voltage, xlab = "datetime", type = "l"))
with(power2Day, plot(Time, Global_reactive_power, xlab = "datetime", type = "l"))
dev.off()